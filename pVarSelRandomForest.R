...
startTime = Sys.time()
print(paste("Script pVarSelRandomForest started executing at: ", startTime))
...
foreach(i=1:nIter, .packages = c('varSelRF', 'randomForest')) %dopar% {
  ...
  save(fitVS,file = paste(getwd(),"/fits/fit", i, ".RData", sep = ""))
}

#print time and total execution time, send Pushbullet notification 
endTime = Sys.time()
execTime = endTime - startTime
msg = paste("Script pVarSelRandomForest finished executing at: ", endTime, "and took ", execTime, " seconds")
print(msg)
